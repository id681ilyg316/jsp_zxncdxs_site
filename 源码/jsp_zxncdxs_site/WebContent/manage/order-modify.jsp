...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li><a href="productSelect">奶茶</a></li>
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">仙缘奶茶店-网上奶茶店</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><em><a href="productAdd">新增</a></em><a href="productSelect">奶茶管理</a></dd>
				<dt>订单管理</dt>
	...
	<div class="main">
		...
		<div class="manage">
				<table border="1"  width="600px" height="100px" bordercolor="red">
					<tr align="center">
						<td class="field">奶茶名称</td>
						<td class="field">奶茶图片</td>
						<td class="field">奶茶价格</td>
						<td class="field">购买数量</td>
						<td class="field">奶茶库存</td>
					</tr>
