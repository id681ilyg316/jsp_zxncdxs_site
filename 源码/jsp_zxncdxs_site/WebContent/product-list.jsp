...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="indexSelect">仙缘奶茶店-网上奶茶店</a> &gt; <a
			href="selectProductList">奶茶分类</a> &gt; ${title }
	</div>
	<div id="main" class="wrap">
		<div class="lefter">
			<div class="box">
				...
				<dl>
					<dt>
						<a href="selectProductList">全部奶茶</a>
					</dt>
					<c:forEach var="f" items="${flist}">
						<dt>
	...
	<div id="footer">Copyright &copy; 2019 仙缘奶茶店-网上奶茶店 All Rights
